...
?>
    ...
    <main id="main" class="site-main">
        ...
        $category_term_id = ( $queried_term && isset( $queried_term->term_id ) ) ? (int) $queried_term->term_id : 0;
        ?>
        <div class="container category-archive category-archive-v2">
            <header class="category-archive-header">
                <h1 class="category-archive-title"><?php echo esc_html( $category_title ); ?></h1>
            </header>
            ...
            if ( ! $hero_query->have_posts() ) {
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class( 'category-hero' ); ?>>
                    ...
                    <header class="category-hero-header">
                        <div class="category-hero-kicker"><?php echo esc_html( $category_title ); ?></div>
                        <?php
                                            ...
                                            <?php foreach ( $box_posts as $post ) : ?>
                                                ...
                                                <article id="post-<?php the_ID(); ?>" <?php post_class( 'category-list-item' ); ?>>
                                                    ...
                                                    <div class="category-list-body">
                                                        <div class="category-list-kicker"><?php echo esc_html( $category_title ); ?></div>
                                                        <?php
                ...
                <?php if ( $has_more ) : ?>
                    <div class="category-load-more-wrap">
                        <button
                            type="button"
                            class="category-load-more js-category-load-more"
                            data-term-id="<?php echo esc_attr( $category_term_id ); ?>"
                            data-offset="<?php echo esc_attr( $rendered_count ); ?>"
                            data-hero-id="<?php echo esc_attr( $hero_id ); ?>"
                            data-nonce="<?php echo esc_attr( wp_create_nonce( 'vanityfair_load_more_category' ) ); ?>"
                        >
                            Load More
                        </button>
                    </div>
